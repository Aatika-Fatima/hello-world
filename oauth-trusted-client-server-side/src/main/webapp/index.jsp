...
<body>
	...
	<script>
		function makeRequest() {
			...
			//var REDIRECT_URI = "http://localhost:8081/oauth-trusted-client-server-side/callbackJSP.jsp";
			var REDIRECT_URI = "http://localhost:8081/oauth-trusted-client-server-side/callbackServlet";
